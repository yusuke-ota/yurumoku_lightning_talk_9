...
* PCVRとスタンドアローンで**スクリプトがある程度**共有できる
...
こまごました機能の確認をXR HMD Mockで行っていた。
が、いろいろ設定をいじった時マウスでのシミュレーションが動かなくなった。
...
* Supported Devicesに何も設定しない
  Supported Devicesに何も設定しない場合、取得でき入力をすべて取得する
